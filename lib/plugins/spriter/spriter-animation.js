...
.defines(function(){ "use strict";
    ...
    ig.SpriterAnimationSheet = ig.Class.extend({
        ...
        /* {ig.spriter.data} spriter scml data */
        data: null,
        ...
        /**
         * constructor
         * @param url    Url of scml file.
         * @param width  Entity width.
         * @param height Entity height.
         * @loadExtra    Load extra assets for flicker or not.
         */
        init: function (url, width, height, loadExtra) {
            this.loadExtra = loadExtra;
            this.width = width;
            this.height = height;

            // load scml
            this.data = new ig.spriter.data(loadExtra);
            var self = this;
    ...
    ig.SpriterAnimation = ig.Class.extend({
        ...
        getRealLength: function () {
            return this.duration / 1000 * this.timeScale;
        },
        /**
                ...
                for (var object_idx = 0, object_len = object_array.length; object_idx < object_len; ++object_idx)
                {
                    ...
                    ctx_2d.save();
                        ...
                        if (file.image && !file.image.hidden)
                        {
                            ...
                            if (this.flkrTint && this.sheet.loadExtra) {
                                ctx_2d.drawImage(file.flkrImg.data, -ex, -ey, 2*ex, 2*ey);
                            } else {
