...
.defines(function(){ 'use strict';
    ...
    ig.SpriterAnimationSheet = ig.Class.extend({
        ...
        init: function (url, width, height) {
            ...
            this.pose = new ig.spriter.Pose(this.data);
        }
    });
    ...
    ig.SpriterAnimation = ig.Class.extend({
        ...
        /**
         * If Signal is included, this will be a Signal instance
         * dispatched when this animation finished.
         */
        onComplete: null,
        ...
        update: function () {
            ...
            var currLoopCount = this.loopCount;
            this.loopCount = pose.loopCount;
            if (this.loopCount > currLoopCount && this.onComplete) {
